package exercicio1.com.funcoes.e.procedimentos;

import java.util.Scanner;

public class Exercicio1ComFuncoesEProcedimentos {
        ...
        nota2 = teclado.nextFloat();
            if(nota_valida(nota2)) {
                ...
                if(nota_valida(nota3)) {
                    ...
                    // chamadado procedimento que exibe a mensagem da media semestral
                    ...
                    if (media_semestral < 4) {
                        ...
                        System.out.println("Informe o a nota obtida no exame: ");
